...
public class IdleShop{
    ...
    private static IdleItem upgrade1 = new IdleItem(0, 1, "", 0, 1, 1.15, 1); 
    private static IdleItem upgrade2 = new IdleItem(1, 2,"", 0, 1, 1.5, 1);
    private static IdleItem upgrade3 = new IdleItem(2, 3, "", 0, 1, 1.4, 5000);
